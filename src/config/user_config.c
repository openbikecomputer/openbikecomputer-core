...
{
	fail_if_false(user_conf.is_initialized, -1, "user_conf is not initialized\n");
...
int user_config_set_brightness(const int value)
{
	...
	fail_if_negative(ret, -2, "set brightness failed, return: %d\n", ret);
...
int user_config_set_gps_on(const int value)
{
	...
	fail_if_negative(ret, -2, "set gps_on failed, return: %d\n", ret);
...
int user_config_set_ant_on(const int value)
{
	...
	fail_if_negative(ret, -2, "set ant_on failed, return: %d\n", ret);
...
int user_config_set_bluetooth_on(const int value)
{
	...
	fail_if_negative(ret, -2, "set bluetooth_on failed, return: %d\n", ret);
...
int user_config_set_wifi_on(const int value)
{
	...
	fail_if_negative(ret, -2, "set wifi_on failed, return: %d\n", ret);
