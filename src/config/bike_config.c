...
{
	fail_if_true(bike_conf.is_initialized, -1, "bike_conf is already initialized\n");
	int ret = 0;
...
{
	fail_if_false(bike_conf.is_initialized, -1, "bike_conf is not initialized\n");
...
{
	fail_if_false(bike_conf.is_initialized, -1, "bike_conf is not initialized\n");
	fail_if_null(brand, -2, "brand is null\n");
...
{
	fail_if_false(bike_conf.is_initialized, -1, "bike_conf is not initialized\n");
	fail_if_null(model, -2, "model is null\n");
...
int bike_config_set_weight(const int weight)
{
	...
	fail_if_negative(ret, -2, "libconfig_helper_set_int failed, return %d\n", ret);
